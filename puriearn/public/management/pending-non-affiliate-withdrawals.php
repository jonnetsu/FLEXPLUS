...
?>
        <div class="container-fluid py-4">
                  <div class="card" style="padding:30px;">
                    <h5 class="card-header">Pending Non-Affiliate Withdrawals</h5>  
                 <div>
                 <?php if(isset($msg)){ ?>
            ...
            <form method="post" action="">
                ...
                <div class="table-responsive table-wrapper-top text-nowrap" >
                  ...
                  <tbody>
                  <?php 
                  $query="SELECT * FROM `transactions` WHERE `status`='Pending' AND `type`='Withdrawal' AND `account_type`='Non Affiliate' ";
