...
&& $imageFileType != "gif" ) {
  ...
  $sql = "INSERT INTO `gift_boxes`(`name`,`description`,`image`,`created_at`)
                     VALUES  ('$title','$description','$post_image','$current_date')";
  
  $result=mysqli_query($con,$sql);
  if($result){ 

    $msg="New Gift Box Added Successfully";
    $type = "success";
    }else{
...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">New/</span> Add Gift Box</h4>
 
 <div class="card mb-4">
                    <h5 class="card-header">New Gift Box</h5>
                    <!-- Account -->
                    <hr class="my-0" />
                    <div class="card-body">
                    <?php if(isset($msg)){ ?>
