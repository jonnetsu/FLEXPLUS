...
?>
        <div class="container-fluid py-4">
                  <div class="card" style="padding:30px;">
                    <h5 class="card-header">Withdrawal History for <?php echo $fullname?></h5>  
                    <h5 class="card-header">Total Referrals-  <?php 
											$query3="SELECT * FROM `users` WHERE `referred_by`='$username'";
            ...
            <form method="post" action="">
                ...
                <div class="table-responsive table-wrapper-top text-nowrap" >
                  ...
                  <tbody>
                  <?php 
                  $query="SELECT * FROM `transactions` WHERE `type`='Withdrawal' AND `user_id`='$uid' ";
