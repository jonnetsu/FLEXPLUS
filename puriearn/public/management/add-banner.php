...
&& $imageFileType != "gif" ) {
  ...
  $sql = "INSERT INTO `images` (`status`,`image_url`)
...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">New/</span> Add Banner</h4>
 
 <div class="card mb-4">
                    <h5 class="card-header">New Banner</h5>
                    <!-- Account -->
                    <hr class="my-0" />
                    <div class="card-body">
                    <?php if(isset($msg)){ ?>
