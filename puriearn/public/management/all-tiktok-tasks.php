...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"DELETE FROM `tiktok_tasks` WHERE `id` = '".$_GET['id']."'");
      ...
      if(isset($_GET['make']))
		  {
        $sql1="UPDATE `tiktok_tasks` SET `status`='1' WHERE `id`='".$_GET['id']."' ";
        $result1=mysqli_query($con,$sql1);
		  }
       //Remove user's a vendor status
       if(isset($_GET['remove']))
       {
         $sql1="UPDATE `tiktok_tasks` SET `status`='0' WHERE `id`='".$_GET['id']."' ";
         $result1=mysqli_query($con,$sql1);
       }
?>
...
<div class="container-fluid py-4">
                  ...
                  <h5 class="card-header">Tiktok Tasks</h5>
                  ...
                  <table class="table table-bordered" id="dataTables-example" >
                    ...
                    <tbody>
                    <?php 
                  $query="SELECT * FROM `tiktok_tasks` ";
                  ...
                  if(mysqli_num_rows($result)>0){
                    ...
                    <tr>
                    <td><?php echo $cnt++;?></td>
                    <th><?php echo htmlentities($row['title']);?></td>
                    <th><?php echo htmlentities($row['video_type']);?></td>
                    <th><?php echo htmlentities($row['tag']);?></td>
                      ...
                      <td class="align-middle">
                        ...
                        <?php }else{ ?>
                          <a href="?id=<?php echo $row['id'];?>&make=vendor" 
                             ...
                             Make Active</a>
                        <?php } ?>
                        <a href="edit-tiktok-task.php?id=<?php echo $row['id'];?>"  class="btn btn-primary ">
                            Edit Task
                            </a>
