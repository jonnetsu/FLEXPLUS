...
<div class="container-fluid py-4">
                  ...
                  <h5 class="card-header">Ad Categories</h5>
                   ...
                   while($row=mysqli_fetch_array($result)){
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="edit-category.php?id=<?php echo $row['id'];?>" class="btn btn-primary" data-toggle="tooltip" data-original-title="Edit Category">
                          Edit
                        </a>
                        <a href="categories.php?id=<?php echo $row['id'];?>&del=delete" 
