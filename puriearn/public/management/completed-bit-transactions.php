...
if(isset($_GET['cancel']))
        ...
        $sql = "UPDATE `bitvortex_transactions` set `status`='Pending',updationDate='$currentTime'
        WHERE `id`='$trans_id' ";	
         $res = mysqli_query($con, $sql);
           if($res){
               ...
               $type = "success";
               echo "<script>window.location.href='completed-bit-transactions.php';</script>";
           }else{
               $msg="Failed to Cancel Withdrawal";
               $type = "warning";
               echo "<script>window.location.href='completed-bit-transactions.php';</script>";
        ...
        <div class="container-fluid py-4">
            ...
            <form method="post" action="">
                ...
                <div class="table-responsive table-wrapper-top text-nowrap" >
                  ...
                  <tbody>
                  <?php 
                  $query="SELECT * FROM `bitvortex_transactions` WHERE `status`='Confirmed' ORDER BY id DESC ";
                  ...
                  if(mysqli_num_rows($result)>0){
                    ...
                    <tr>
                      ...
                      <a href="?pend=true&&wid=<?php echo $row['id'];?>" 
                      onClick="return confirm('Are you sure you want pend this transactions?')" class="btn btn-warning me-1 add-to-cart-button" >Pend</a> 
