...
if(isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `daily_task` (`title`, `description`, `url`, `created_at`) VALUES (?, ?, ?, ?)";

  $stmt = $con->prepare($sql);
  $stmt->bind_param("ssss", $title, $description, $url, $current_date);
...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">New/</span> Add Social Task</h4>
                    ...
                    <form  method="post" action="" enctype="multipart/form-data">
                      ...
                      <div class="mb-3 col-md-12">
                       ...
                       <div class="mb-3 col-md-12">
                        ...
                        <input type="text"  name="url" id="" value="<?php if(isset($_POST['url'])) echo $_POST['url']; ?>" class="form-control" required>
                      </div>
                        </div>
                        <div class="mt-2">
